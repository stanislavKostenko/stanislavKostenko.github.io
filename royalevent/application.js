...
var _mainSlider = __webpack_require__(330);

var _rewies_slider = __webpack_require__(332);

var _header = __webpack_require__(334);

var mySlider = new _mainSlider.Slider('.slider-1');
var myReviewSlider = new _rewies_slider.ReviewSlider('.slider-2');
var myMenu = new _header.Menu('.menu-1');
...
var Slider = function () {
    ...
    _createClass(Slider, [{
        ...
        value: function handleEvents() {
            ...
            this.rootElement.addEventListener('mouseenter', function () {
                clearInterval(_this.intervalIdSlides);
            });

            this.rootElement.addEventListener('mouseleave', function () {
                _this.autoShowSlides();
            });

            this.rootElement.addEventListener('mouseenter', function () {
                clearInterval(_this.intervalIdPager);
            });
            ...
            this.pager.forEach(function (item, i) {
                item.addEventListener('click', function (e) {
                    _this.slideIndex = i;
                    _this.pagerIndex = i;
                    if (e.target) {
                        _this.goToSlide(_this.slideIndex);
                        if (!e.target.classList.contains('active')) {
                            _this.pager.forEach(function (el) {
        ...
        key: 'goToPager',
        value: function goToPager(n) {
            this.pager.forEach(function (el) {
                return el.classList.remove('active');
            });
...
exports.ReviewSlider = undefined;
...
var ReviewSlider = function () {
    function ReviewSlider(cssSelector) {
    ...
    _createClass(ReviewSlider, [{
        ...
        value: function handleEvents() {
            ...
            this.previousEl.addEventListener('click', function (e) {
                if (e.target) {
                    _this.previousSlide();
                }
            });
        ...
        key: 'goToSlideAvatar',
        value: function goToSlideAvatar(n) {
            this.slidesAvatar.forEach(function (el) {
                return el.classList.remove('active');
            });
        ...
        key: 'goToSlideReview',
        value: function goToSlideReview(n) {
            this.slidesReview.forEach(function (el) {
                return el.classList.remove('active');
            });
        ...
        key: 'goToSlideAuthor',
        value: function goToSlideAuthor(n) {
            this.slidesAuthor.forEach(function (el) {
                return el.classList.remove('active');
            });
